...
import com.mycompany.proyecto.mapping.MappingPerfil;
...
public class PerfilController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       line = reader.readLine();
        ...
        MappingPerfil mapping = new MappingPerfil(PerfilModel.class);
        PerfilModel modelo = mapping.ConvertirdeJson(body);
