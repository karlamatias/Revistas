 ...
 * @author karlamatias
 */
@WebServlet(name = "ReporteRevistasController", urlPatterns = {"/ReporteRevistas"})
public class ReporteRevistasController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (report == null || report.equals("") || report.equals("1")) {
                ...
                reportService.RevistasComentadas(response.getOutputStream());
            } else {
